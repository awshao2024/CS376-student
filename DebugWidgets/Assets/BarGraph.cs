...
public class BarGraph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector2 start_position = BarTransform.localPosition;

        if(Min < 0)
        {
            start_position.x = width / 2;
            signedDisplay = true;
        } else
        {
            start_position.x = 0;
        ...
        BarTransform.localPosition = start_position;
    ...
    public void SetReading(float value)
    {
        ...
        SetWidthPercent(bounded_value, color);
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        BarTransform.localScale = new_scale;
